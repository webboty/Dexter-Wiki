...
|# | Name | Description | Default | Suggested Range | DDE Units | Socket Units | Socket Type
| --- | --- | ----- | ---- | ---- | ---- | ---- | ----
|0 | "**MaxSpeed**" | Maximum velocity of next move in "nbits"<sup><a href="#1">1</a></sup>. [Default](https://github.com/HaddingtonDynamics/Dexter/search?q=ACCELERATION_MAXSPEED_DEF&unscoped_q=ACCELERATION_MAXSPEED_DEF) is 250000. See also StartSpeed below. | 30 | 0.001 - 45 | (deg/s) | (nbits) | integer
|1 | "**Acceleration**" | Maximum acceleration of next move in  "nbits"<sup><a href="#1">1</a></sup>. [Default](https://github.com/HaddingtonDynamics/Dexter/search?q=ACCELERATION_MAXSPEED_DEF&unscoped_q=ACCELERATION_MAXSPEED_DEF) is 3. | 0.001 | (deg/s) | (nbits) | integer
