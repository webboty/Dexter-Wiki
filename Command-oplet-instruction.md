...
<a name="b">**b**</a>|"move_to"|n/a|Queued. Use "Dexter.move_to" in DDE which calculates joint angles and sends an 'a' oplet. In DexRun, this oplet is superseded by "M". See: [Kinematics](Kinematics)
