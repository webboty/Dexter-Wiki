...
<a name="b">**b**</a>|"move_to"|n/a|Queued. Use "Dexter.move_to" in DDE which calculates joint angles and sends an 'a' oplet. In DexRun, this oplet is superseded by <a href="#M">'M'</a>. See: [Kinematics](Kinematics)
...
<a name="T">**T**</a>|"move_to_straight"<sup>1</sup>|MOVETOSTRAIGHT_CMD|Use "Dexter.move_to_straight" in DDE which calculates a sequence of joint angles and sends a bunch of 'a' oplets with speed settings. 'T' does onboard [kinematics](Kinematics) move in a straight line from prior <a href="#M">'M' oplet</a> position to new XYZ position, direction, and configuration. See [S CartesianSpeed](set-parameter-oplet#CartesianSpeed)
