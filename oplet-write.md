...
57 |  <strike>DIFF_FORCE_ANGLE_COMPENSATE</strike> (Now EXTRUDER_CONTROL)  | <strike>Unused. </strike> Since 2019: Drive the extra stepper driver output labeled "external" on the green board<BR><TT>make_ins("w", 57, 300001)  //Goes backwards at speed 300000</TT><BR><TT>make_ins("w", 57, 300000) //Goes forward at speed 300000</TT><BR><TT>make_ins("w", 57, 0) //Stops</TT><BR>A good range is 50000 (slow) to 500000 (fast)
